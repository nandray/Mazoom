    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                 <li class="nav-item">
                    <a class="nav-link page-scroll" href="owner.php" style="color: #269B95">الملف الشخصي <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="services.html" style="color: #269B95">خدماتك <span class="sr-only">(current)</span></a>
                </li>
                  <li class="nav-item">
...
<h6 style="color: #505050"><?php echo $row["details"]; ?></h6>
 ...
 <div class="footer">
        <div class="container">
    <button type="submit" class="btn btn-default discover"  style="background-color:#77C9C5" >أضف خدمة </button>
</div></div>
